            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-9 text-center">
                    <div class="blog__hero__text">
                        <h2>How To Build The Ultimate Men’s Minimalist Wardrobe</h2>
                        <ul>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-12">
                    <div class="blog__details__pic">
                        <img class="img-fluid" src="./images/blog1main.webp" alt="">
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="blog__details__content">
                        ...
                        <div class="blog__details__text">
                            <p>What does the word minimalist mean to you? White-washed, Instagram-bait interiors? Overpriced Scandinavian designers? Kinfolk magazine? IKEA flatpack furniture?
...
Sound good? Here’s everything you need to know when it comes to building your own.</p>
                        </div>
