            ...
            <tr>
                                    <td class="product__cart__item">
                                         <div class="product__cart__item__pic">
                                            <img src="./product_images/<?php echo ''.$file.''; ?>" alt="" class="img-fluid" style="height:150px ;">
                                        </div>
                                        <div class="product__cart__item__text">
                                            <h6><?php echo ''.$name.''; ?></h6>
                                            <h5 class="cart-price">$ <?php echo ''.$price.''; ?></h5>
                                        </div>
                                    </td>
                                    <td class="quantity__item">
                                        <div class="quantity">
                                            
                                             <h5 class="cart-quantity-input"><?php echo ''.$quantity.''; ?></h5>
                                            
                                            
                                        </div>
                                    </td>
                                    <td class="cart__price">$<?php echo ''.$total1.''; ?></td>
                                    

                                    <td class="cart__close">
                                        <a href="delcartitem.php?id=<?php echo $id?>"><i class="fa fa-close"></i></a></td>
                                </tr>
