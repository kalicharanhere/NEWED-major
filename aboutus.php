            ...
            <div class="testimonial__text">
              ...
              <div class="testimonial__author">
                <div class="testimonial__author__pic">
                  <img src="./images/kalicharan1.jpg"  class="img-fluid img-responsive"alt="" />
                </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="team__item">
              <img src="./images/kalicharan1.jpg" alt="" class="img-fluid" />
              <h4>Kali Charan</h4>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="team__item">
              <img src="./images/IMG_20220410_132404_915.jpg" alt="" />
              <h4 class="mt-1">Ananth</h4>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="team__item">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="team__item">
              <img src="./images/abinash.jpg" alt="" />
              <h4>Abinash</h4>
            </div>
          </div>
        </div>
